...
**Minimal reproducible report for upstream:** [`upstream/MCP-USE-FIGMA-BUNDLE-MRE.md`](./upstream/MCP-USE-FIGMA-BUNDLE-MRE.md) · **Acceptance criteria:** [`upstream/OPTION-D-ACCEPTANCE-CRITERIA.md`](./upstream/OPTION-D-ACCEPTANCE-CRITERIA.md) · **Post-fix validation:** [`upstream/STEP-15-POST-OPTION-D-VALIDATION.md`](./upstream/STEP-15-POST-OPTION-D-VALIDATION.md) · **Filing checklist:** [`upstream/README.md`](./upstream/README.md).
...
| 2026-04-21 | **Upstream pack:** [`upstream/README.md`](./upstream/README.md) (filing checklist), [`upstream/MCP-USE-FIGMA-BUNDLE-MRE.md`](./upstream/MCP-USE-FIGMA-BUNDLE-MRE.md), [`upstream/OPTION-D-ACCEPTANCE-CRITERIA.md`](./upstream/OPTION-D-ACCEPTANCE-CRITERIA.md), [`upstream/STEP-15-POST-OPTION-D-VALIDATION.md`](./upstream/STEP-15-POST-OPTION-D-VALIDATION.md); RFC § References cross-link; [issue #4](https://github.com/JBabcock-DL/DesignOps-plugin/issues/4) comment with links for Figma + Cursor duplicate tickets. |
