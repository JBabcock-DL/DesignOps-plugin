...
**Maps to:** Orchestrator DAG **#7** [`13` §1](../conventions/13-component-draw-orchestrator.md); slice runner [**§2**](../../create-component-figma-slice-runner/SKILL.md) → `create-component-engine-doc.step3.min.figma.js`.

**EXECUTOR:** Step **6**, **draw leg 7/10** — finish this phase before [`08`](./08-slice-cc-doc-matrix.md).
