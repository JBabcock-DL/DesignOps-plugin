...
**EXECUTOR:** Step **6**, **slice 1 of 6** (same logical Step 6 as phases 05–09).
...
**If `ok: false`:** **Stop** — do not start [`05-slice-cc-doc-props.md`](./05-slice-cc-doc-props.md).

**Also read:** [`09-mcp-multi-step-doc-pipeline.md`](../conventions/09-mcp-multi-step-doc-pipeline.md) **§1** (dependency order).

**Next:** [`05-slice-cc-doc-props.md`](./05-slice-cc-doc-props.md)
