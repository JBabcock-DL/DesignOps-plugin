...
# Phase 10 — Draw slice `cc-doc-usage` (Do / Don’t)

**Maps to:** Orchestrator DAG **#11** in [`13` §1](../conventions/13-component-draw-orchestrator.md); slice runner [**§2**](../../create-component-figma-slice-runner/SKILL.md) → `create-component-engine-doc.step5.min.figma.js`.

**EXECUTOR:** Step **6**, **draw leg 11/12** — finish this phase before [`11-slice-cc-doc-finalize.md`](./11-slice-cc-doc-finalize.md).
...
**Next:** [`11-slice-cc-doc-finalize.md`](./11-slice-cc-doc-finalize.md)
