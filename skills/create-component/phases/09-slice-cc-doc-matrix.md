...
# Phase 09 — Draw slice `cc-doc-matrix` (Variants × States matrix)

**Maps to:** Orchestrator DAG **#10** in [`13` §1](../conventions/13-component-draw-orchestrator.md); slice runner [**§2**](../../create-component-figma-slice-runner/SKILL.md) → `create-component-engine-doc.step4.min.figma.js`.

**EXECUTOR:** Step **6**, **draw leg 10/12** — finish this phase before [`10-slice-cc-doc-usage.md`](./10-slice-cc-doc-usage.md).
...
**Next:** [`10-slice-cc-doc-usage.md`](./10-slice-cc-doc-usage.md)
