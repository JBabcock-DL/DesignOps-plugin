...
// ═══════════════════════════════════════════════════════════════════════════
// Shared draw helpers + 7 archetype builders used by SKILL.md §6.2a
...
// between §5.6 (DEFAULT_ICON_COMPONENT resolution) and §6.0 (clear page).
//
...
// to the 'chip' fallback in §6.2a and render incorrectly.
//
...
//
// Dependencies provided by the SKILL.md scaffold ABOVE the insertion
// point (do not re-declare them):
//
...
//   buildVariant(...)              — SKILL.md §5.7 chip archetype
//
// What this file provides (hoisted to top-level, so §6.2a dispatch can
// resolve every builder by name regardless of insertion order):
//
