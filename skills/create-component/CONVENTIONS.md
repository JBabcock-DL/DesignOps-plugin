...
| [`conventions/09-mcp-multi-step-doc-pipeline.md`](./conventions/09-mcp-multi-step-doc-pipeline.md) | Seven-call ladder · per-layout `*.step0` + shared `create-component-engine-doc.step1..6` (scaffold + fill + component + matrix + usage + finalize) · **§1.1** placeholders |
