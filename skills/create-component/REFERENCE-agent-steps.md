# Agent instructions — Steps 1 through 8

> **Read order:** [`phases/00-index.md`](./phases/00-index.md) (chronology) · [`EXECUTOR.md`](./EXECUTOR.md) (step numbers, assembly, transport) · **this file** (prose for Steps 1–8). **§9 self-check** (pass/fail “drawn”): [`SKILL.md`](./SKILL.md).
