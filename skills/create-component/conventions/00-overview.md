...
>
> **Authoritative source:** [`skills/create-component/SKILL.md`](../SKILL.md) (**§9** gate) and [`REFERENCE-agent-steps.md`](../REFERENCE-agent-steps.md) (Steps **1–8** narrative). When any of these sub-files disagrees with the skill router, the **router + EXECUTOR** win for assembly/transport; **conventions/** win geometry. **Quickstart / assembly:** [`skills/create-component/EXECUTOR.md`](../EXECUTOR.md).
>
...
| Cursor / Composer; `use_figma` transport + Step 6 runbook | [`08-cursor-composer-mcp.md`](./08-cursor-composer-mcp.md) |
