...
| /create-component | `/create-component [components...]` | components: shadcn component names | Installs components, wires tokens.css, draws each into a matrix-default doc frame (header + properties table + variant × state matrix + usage notes) per `skills/create-component/CONVENTIONS.md` |
