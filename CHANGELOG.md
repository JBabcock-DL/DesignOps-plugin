...
- **[`skills/create-component/conventions/22-deterministic-agent-flows.md`](skills/create-component/conventions/22-deterministic-agent-flows.md)** — Flow **P** master loop, Strategy **I** vs **D**, flows **I** / **D** / **W** / **C**, recovery table **R-***, mermaid state machine. Cross-links **`21`**, **`13`**, **`AGENTS`**.
- **`scripts/designops-step6-engine.mjs`** (`npm run designops:step6:*`), **`scripts/lib/designops-step6-status.mjs`**, **`scripts/config-projection.mjs`** + **`scripts/config-projection-map.json`** (Tier 1 hook in **`assemble-slice`**), **`scripts/qa-assembled-size.mjs`**, **`scripts/qa-config-projection.mjs`** (`npm run qa:config-projection`; wired into **`npm run verify`**), **`scripts/designops-canvas-session.mjs`**. **[`skills/create-component/conventions/23-designops-step6-engine.md`](skills/create-component/conventions/23-designops-step6-engine.md)**; **[`24-thin-doc-engine-split-plan.md`](skills/create-component/conventions/24-thin-doc-engine-split-plan.md)** (W3 follow-on).

### Changed — MCP payloads: ephemeral staging allowed

- **`AGENTS.md`**, **[`.cursor/rules/mcp-inline-payloads.mdc`](.cursor/rules/mcp-inline-payloads.mdc)**, [`CLAUDE.md`](CLAUDE.md), [`memory.md`](memory.md), [`20-mcp-payload-shrink-solution.md`](skills/create-component/conventions/20-mcp-payload-shrink-solution.md) — Default remains **inline** `use_figma` `code`; **`assemble-slice --out`** / **`--emit-mcp-args`** + parent **`Read`** → `call_mcp` is documented when IDE transport needs it — still **no** persistent staging under **`skills/`** or duplicate copies of committed bundles.

### Added — MCP payload shrink roadmap

- **[`skills/create-component/conventions/20-mcp-payload-shrink-solution.md`](skills/create-component/conventions/20-mcp-payload-shrink-solution.md)** — tiers (baselines, CONFIG projection, draw-engine late entry, `build-min` engine splits, tuple/ops, registry diet), rollout P0–P4, success criteria. Cross-links from [`18-mcp-payload-budget.md`](skills/create-component/conventions/18-mcp-payload-budget.md), [`00-overview.md`](skills/create-component/conventions/00-overview.md), [`memory.md`](memory.md).

### Added — per-slice payload budget (8–10 kB target)

- **[`skills/create-component/conventions/18-mcp-payload-budget.md`](skills/create-component/conventions/18-mcp-payload-budget.md)** — North star for `use_figma` wire size: **more** small rounds, not bigger strings. Linked from [`AGENTS.md`](AGENTS.md), [`memory.md`](memory.md), [`COMPOSER.md`](skills/create-component/COMPOSER.md), [`phases/00-index.md`](skills/create-component/phases/00-index.md), [`00-overview` router](skills/create-component/conventions/00-overview.md), [`12-sigma-budget-mcp.md`](skills/create-component/conventions/12-sigma-budget-mcp.md), [`EXECUTOR.md`](skills/create-component/EXECUTOR.md).
...
- Normative and operator docs updated: [`13-component-draw-orchestrator.md`](skills/create-component/conventions/13-component-draw-orchestrator.md), phase **04**, [`17-scaffold-sub-slice-states.md`](skills/create-component/conventions/17-scaffold-sub-slice-states.md), [`create-component-figma-slice-runner/SKILL.md`](skills/create-component-figma-slice-runner/SKILL.md), [`EXECUTOR.md`](skills/create-component/EXECUTOR.md), [`AGENTS.md`](AGENTS.md), [`memory.md`](memory.md), [`CLAUDE.md`](CLAUDE.md), and related cross-links.
